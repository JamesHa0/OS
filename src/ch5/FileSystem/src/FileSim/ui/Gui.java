...
public class Gui extends JFrame {
	...
	private JTextPane getTextPane() {
		if (TextPane == null) {
			...
			TextPane.setFont(new Font("宋体",Font.BOLD,25));
		}
		return TextPane;
	}
	...
	private JButton getCreatFile() {
		if (creatFile == null) {
			...
			creatFile.setFont(new Font("宋体",Font.BOLD,25));
	...
	private JEditorPane getFileNameEditorPane() {
		if (FileNameEditorPane == null) {
			...
			FileNameEditorPane.setFont(new Font("宋体",Font.BOLD,25));
		}
	...
	private JEditorPane getFindEditorPane() {
		if (FindEditorPane == null) {
			...
			FindEditorPane.setFont(new Font("宋体",Font.BOLD,25));
		}
	...
	private MapViewer getMapPanel() {
		if (mapPanel == null) {
			...
			mapPanel.setFont(new Font("宋体",Font.BOLD,25));
		}
		return mapPanel;
	}
	...
	private JMenuItem getHelpMenu() {
		...
		if (helpMenu == null) {
			helpMenu = new JMenu();
			helpMenu.setText("帮助");
			helpMenu.setFont(new Font("宋体",Font.BOLD,25));
	...
	private JMenuItem getAboutMenuItem() {
		if (aboutMenuItem == null) {
			...
			aboutMenuItem.setFont(new Font("宋体",Font.BOLD,25));
	...
	private JButton getDeleteButton1() {
		if (deleteButton1 == null) {
			...
			deleteButton1.setFont(new Font("宋体",Font.BOLD,25));
